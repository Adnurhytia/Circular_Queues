...
namespace CircularQueues_CSharp
{
    class Queues
    {
        ...
        public void insert(int element)
        {
            ...
            /* The following statement checks whether the queue is empty. If the queue is empty, then the values of the REAR and FRONT variabels is set to 0.*/
            if (FRONT == -1)
            {
                FRONT = 0;
                REAR = 0;
        ...
        public void display()
        {
            ...
            {
                /*traverses the queue till last element present in an array.*/
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Check for the values enetered.");
                }
            }
        }
    }
